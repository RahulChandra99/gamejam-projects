...
public class FadeToRedScript : MonoBehaviour
{
    ...
    private static FadeToRedScript instance;

    public static FadeToRedScript GetInstance()
    {
		return instance;
    }
    // Reference to game objects Sprite Renderer component
    SpriteRenderer rend;
    public Animator birdTransferAnimation;
    ...
    {
		instance = this;
        birdTransferAnimation.SetBool("isDark", false);
    }
    ...
    {
        birdTransferAnimation.SetBool("isDark", true);
